import 'package:fitness_and_nutrition/presentation/view/first/first_cubit.dart';
import 'package:fitness_and_nutrition/presentation/view/first/first_widget.dart';
...
class _FirstScreenState extends State<FirstScreen> {
  ...
  Widget build(BuildContext context) {
    print('hề vcl');
    int pageIndex = context.select((FirstCubit cubit) => cubit.state);
    ...
    return Scaffold(
      ...
      children: [
        Container(
            ...
            child: FirstWidget(controller, pageIndex)),
        Positioned(
              ...
              GestureDetector(
                onTap: () {
                  Navigator.of(context)
                      .pushReplacementNamed(RouteGenerator.setupScreen);
                },
                child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Text(
                      ...
                      style: TextStyle(
                          color: AppColor.black, fontSize: AppDimens.dimens_12),
                    ),
                    const SizedBox(
                      width: AppDimens.dimens_16,
                    ),
